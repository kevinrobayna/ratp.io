...
# Unit tests for OpenapiClient::ProfileAlertModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ProfileAlertModel do
  let(:instance) { OpenapiClient::ProfileAlertModel.new }

  describe 'test an instance of ProfileAlertModel' do
    it 'should create an instance of ProfileAlertModel' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ProfileAlertModel)
    end
  end
