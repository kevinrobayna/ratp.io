...
module RaptApiClient
  class ProfileSessionStatusModel
    attr_accessor :id
    ...
    def hash
      [id, deleted, created_on, created_by, modified_on, modified_by, name, profile_id, profile, fermentation_chamber_id, hydrometer_id, temperature_controller_id, brew_zilla_id, start_date, end_date, original_gravity, final_gravity, sent_alerts, estimated_end_date, profile_length, current_profile_time, remaining_profile_time].hash
    end
