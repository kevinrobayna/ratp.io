...
# Unit tests for OpenapiClient::ProfileStepAlertModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ProfileStepAlertModel do
  let(:instance) { OpenapiClient::ProfileStepAlertModel.new }

  describe 'test an instance of ProfileStepAlertModel' do
    it 'should create an instance of ProfileStepAlertModel' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ProfileStepAlertModel)
    end
  end
