...
module RaptApiClient
  class ExternalDeviceModel < ApiModelBase
    attr_accessor :id
    ...
    def self.openapi_types
      {
        ...
        :'mac_address' => :'String',
        :'telemetry' => :'Array<ExternalDeviceTelemetryModel>',
        :'temperature' => :'Float',
        :'gravity' => :'Float',
        :'pressure' => :'Float',
        :'battery' => :'Float'
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RaptApiClient::ExternalDeviceModel` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RaptApiClient::ExternalDeviceModel`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [id, deleted, created_on, created_by, modified_on, modified_by, name, serial_number, device_type, active, disabled, username, connection_state, status, error, last_activity_time, rssi, firmware_version, is_latest_firmware, active_profile_id, active_profile_step_id, active_profile_session, mac_address, telemetry, temperature, gravity, pressure, battery].hash
    end
