...
module RaptApiClient
  class HydrometerModel < ApiModelBase
    attr_accessor :id
    ...
    attr_accessor :paired_device_type

    attr_accessor :paired_device_id

    attr_accessor :temperature

    attr_accessor :gravity

    attr_accessor :gravity_velocity
    ...
    def self.attribute_map
      {
        ...
        :'telemetry' => :'telemetry',
        :'paired_device_type' => :'pairedDeviceType',
        :'paired_device_id' => :'pairedDeviceId',
        :'temperature' => :'temperature',
        :'gravity' => :'gravity',
        :'gravity_velocity' => :'gravityVelocity',
        :'battery' => :'battery'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'telemetry' => :'Array<HydrometerTelemetryModel>',
        :'paired_device_type' => :'DeviceTypesNullable',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RaptApiClient::HydrometerModel` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RaptApiClient::HydrometerModel`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'paired_device_type')
        self.paired_device_type = attributes[:'paired_device_type']
      end

      if attributes.key?(:'paired_device_id')
        self.paired_device_id = attributes[:'paired_device_id']
      end
      ...
      if attributes.key?(:'gravity_velocity')
        self.gravity_velocity = attributes[:'gravity_velocity']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          paired_device_type == o.paired_device_type &&
          paired_device_id == o.paired_device_id &&
          temperature == o.temperature &&
          gravity == o.gravity &&
          gravity_velocity == o.gravity_velocity &&
          battery == o.battery
    end
    ...
    def hash
      [id, deleted, created_on, created_by, modified_on, modified_by, name, serial_number, mac_address, device_type, active, disabled, username, connection_state, status, error, last_activity_time, rssi, firmware_version, is_latest_firmware, active_profile_id, active_profile_step_id, active_profile_session, telemetry, paired_device_type, paired_device_id, temperature, gravity, gravity_velocity, battery].hash
    end
