...
module RaptApiClient
  class ProfileModel < ApiModelBase
    attr_accessor :id
    ...
    def self.openapi_types
      {
        ...
        :'alerts' => :'Array<ProfileAlertModel>',
        :'steps' => :'Array<ProfileStepModel>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RaptApiClient::ProfileModel` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RaptApiClient::ProfileModel`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'rating_score')
        self.rating_score = attributes[:'rating_score']
      end

      if attributes.key?(:'copy_count')
        self.copy_count = attributes[:'copy_count']
      end
      ...
      if attributes.key?(:'profile_type_id')
        self.profile_type_id = attributes[:'profile_type_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          rating_score == o.rating_score &&
          copy_count == o.copy_count &&
          view_count == o.view_count &&
          profile_type_id == o.profile_type_id &&
          alerts == o.alerts &&
          steps == o.steps &&
    ...
    def hash
      [id, deleted, created_on, created_by, modified_on, modified_by, name, description, public, profile_name, rating, rating_count, rating_score, copy_count, view_count, profile_type_id, alerts, steps, profile_sessions].hash
    end
