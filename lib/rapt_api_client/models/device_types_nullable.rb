...
module RaptApiClient
  class DeviceTypesNullable
    ...
    def self.all_vars
      @all_vars ||= [FERMENTATION_CHAMBER, TEMPERATURE_CONTROLLER, HYDROMETER, GRAIN_WEIGH, BREW_ZILLA, CAN_FILLER, GLYCOL_CHILLER, STILL, BLE_TEMPERATURE, BLE_HUMIDITY, BLE_TEMP_HUMIDITY, BLE_PRESSURE, EXTERNAL, FRIDGE, GRAIN_WEIGH_DEVICE, UNKNOWN].freeze
    end
    ...
    def build_from_hash(value)
      return value if DeviceTypesNullable.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #DeviceTypesNullable"
    end
  end
end
