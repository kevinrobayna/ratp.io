...
module RaptApiClient
  class FermentationChamberModel < ApiModelBase
    attr_accessor :id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RaptApiClient::FermentationChamberModel` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RaptApiClient::FermentationChamberModel`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'fan_enabled')
        self.fan_enabled = attributes[:'fan_enabled']
      end

      if attributes.key?(:'light_enabled')
        self.light_enabled = attributes[:'light_enabled']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @mac_address.to_s.length < 1
        invalid_properties.push('invalid value for "mac_address", the character length must be greater than or equal to 1.')
      end
      ...
      if @customer_use.to_s.length < 1
        invalid_properties.push('invalid value for "customer_use", the character length must be greater than or equal to 1.')
      end
      ...
      if !@compressor_delay.nil? && @compressor_delay < 2
        invalid_properties.push('invalid value for "compressor_delay", must be greater than or equal to 2.')
      end
      ...
      if !@mode_switch_delay.nil? && @mode_switch_delay < 2
        invalid_properties.push('invalid value for "mode_switch_delay", must be greater than or equal to 2.')
      end
      ...
      if !@cooling_hysteresis.nil? && @cooling_hysteresis < 0.5
        invalid_properties.push('invalid value for "cooling_hysteresis", must be greater than or equal to 0.5.')
      end
      ...
      if !@heating_hysteresis.nil? && @heating_hysteresis < 0.1
        invalid_properties.push('invalid value for "heating_hysteresis", must be greater than or equal to 0.1.')
      end
    ...
    def valid?
      ...
      return false if !@compressor_delay.nil? && @compressor_delay < 2
      return false if !@mode_switch_delay.nil? && @mode_switch_delay > 30
      return false if !@mode_switch_delay.nil? && @mode_switch_delay < 2
      return false if !@cooling_hysteresis.nil? && @cooling_hysteresis > 10
      return false if !@cooling_hysteresis.nil? && @cooling_hysteresis < 0.5
      return false if !@heating_hysteresis.nil? && @heating_hysteresis > 10
      return false if !@heating_hysteresis.nil? && @heating_hysteresis < 0.1
      true
    end
    ...
    def mac_address=(mac_address)
      ...
      if mac_address.to_s.length < 1
        fail ArgumentError, 'invalid value for "mac_address", the character length must be greater than or equal to 1.'
      end
    ...
    def customer_use=(customer_use)
      ...
      if customer_use.to_s.length < 1
        fail ArgumentError, 'invalid value for "customer_use", the character length must be greater than or equal to 1.'
      end
    ...
    def compressor_delay=(compressor_delay)
      ...
      if compressor_delay < 2
        fail ArgumentError, 'invalid value for "compressor_delay", must be greater than or equal to 2.'
      end
    ...
    def mode_switch_delay=(mode_switch_delay)
      ...
      if mode_switch_delay < 2
        fail ArgumentError, 'invalid value for "mode_switch_delay", must be greater than or equal to 2.'
      end
    ...
    def cooling_hysteresis=(cooling_hysteresis)
      ...
      if cooling_hysteresis < 0.5
        fail ArgumentError, 'invalid value for "cooling_hysteresis", must be greater than or equal to 0.5.'
      end
    ...
    def heating_hysteresis=(heating_hysteresis)
      ...
      if heating_hysteresis < 0.1
        fail ArgumentError, 'invalid value for "heating_hysteresis", must be greater than or equal to 0.1.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          fan_enabled == o.fan_enabled &&
          light_enabled == o.light_enabled
    end
    ...
    def hash
      [id, deleted, created_on, created_by, modified_on, modified_by, name, serial_number, mac_address, device_type, active, disabled, username, connection_state, status, error, last_activity_time, rssi, firmware_version, is_latest_firmware, active_profile_id, active_profile_step_id, active_profile_session, profile_sessions, beta_updates, bluetooth_enabled, graph_zoom_level, temperature, target_temperature, min_target_temperature, max_target_temperature, total_run_time, cooling_enabled, cooling_run_time, cooling_starts, heating_enabled, heating_run_time, heating_starts, heating_utilisation, high_temp_alarm, low_temp_alarm, ntc_beta, ntc_ref_resistance, ntc_ref_temperature, pid_cycle_time, pid_enabled, pid_proportional, pid_integral, pid_derivative, sensor_differential, sensor_timeout, show_graph, sounds_enabled, temp_unit, use_internal_sensor, control_device_type, control_device_mac_address, control_device_temperature, customer_use, telemetry_frequency, compressor_delay, mode_switch_delay, cooling_hysteresis, heating_hysteresis, telemetry, compressor_run_time, compressor_starts, auxillary_run_time, auxillary_starts, fan_enabled, light_enabled].hash
    end
