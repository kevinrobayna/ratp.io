...
*RaptApiClient::StillApi* | [**api_stills_get_still_get**](docs/StillApi.md#api_stills_get_still_get) | **GET** /api/Stills/GetStill | 
*RaptApiClient::StillApi* | [**api_stills_get_stills_get**](docs/StillApi.md#api_stills_get_stills_get) | **GET** /api/Stills/GetStills | 
*RaptApiClient::StillApi* | [**api_stills_get_telemetry_get**](docs/StillApi.md#api_stills_get_telemetry_get) | **GET** /api/Stills/GetTelemetry | 
*RaptApiClient::StillApi* | [**api_stills_set_heating_enabled_post**](docs/StillApi.md#api_stills_set_heating_enabled_post) | **POST** /api/Stills/SetHeatingEnabled | 
*RaptApiClient::StillApi* | [**api_stills_set_heating_utilisation_post**](docs/StillApi.md#api_stills_set_heating_utilisation_post) | **POST** /api/Stills/SetHeatingUtilisation | 
*RaptApiClient::StillApi* | [**api_stills_set_pid_enabled_post**](docs/StillApi.md#api_stills_set_pid_enabled_post) | **POST** /api/Stills/SetPIDEnabled | 
*RaptApiClient::StillApi* | [**api_stills_set_pid_post**](docs/StillApi.md#api_stills_set_pid_post) | **POST** /api/Stills/SetPID | 
*RaptApiClient::StillApi* | [**api_stills_set_pump_enabled_post**](docs/StillApi.md#api_stills_set_pump_enabled_post) | **POST** /api/Stills/SetPumpEnabled | 
*RaptApiClient::StillApi* | [**api_stills_set_pump_utilisation_post**](docs/StillApi.md#api_stills_set_pump_utilisation_post) | **POST** /api/Stills/SetPumpUtilisation | 
*RaptApiClient::StillApi* | [**api_stills_set_target_temperature_post**](docs/StillApi.md#api_stills_set_target_temperature_post) | **POST** /api/Stills/SetTargetTemperature | 
...
## Documentation for Models
 ...
 - [RaptApiClient::AmountTypes](docs/AmountTypes.md)
 ...
 - [RaptApiClient::DeviceTypesNullable](docs/DeviceTypesNullable.md)
 ...
 - [RaptApiClient::ProfileStepDurationTypesNullable](docs/ProfileStepDurationTypesNullable.md)
 ...
 - [RaptApiClient::ProfileValueOperatorsNullable](docs/ProfileValueOperatorsNullable.md)
 - [RaptApiClient::StillModel](docs/StillModel.md)
 - [RaptApiClient::StillTelemetryModel](docs/StillTelemetryModel.md)
 ...
 - [RaptApiClient::YeastModel](docs/YeastModel.md)
