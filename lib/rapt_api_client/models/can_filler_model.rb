...
module RaptApiClient
  class CanFillerModel < ApiModelBase
    attr_accessor :id
    ...
    attr_accessor :empty_pressure

    attr_accessor :calibration_factor

    attr_accessor :min_fill_rate

    attr_accessor :fill_timeout

    attr_accessor :temperature_offset

    attr_accessor :fill_presets

    attr_accessor :total_fill_count

    attr_accessor :total_failed_count

    attr_accessor :last_fill_session
    ...
    def self.openapi_types
      {
        ...
        :'empty_pressure' => :'Float',
        :'calibration_factor' => :'Float',
        :'min_fill_rate' => :'Float',
        :'fill_timeout' => :'Float',
        :'temperature_offset' => :'Float',
        :'fill_presets' => :'Array<FillPresetModel>',
        :'total_fill_count' => :'Integer',
        :'total_failed_count' => :'Integer',
        :'last_fill_session' => :'FillSessionModel'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RaptApiClient::CanFillerModel` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RaptApiClient::CanFillerModel`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'empty_pressure')
        self.empty_pressure = attributes[:'empty_pressure']
      end

      if attributes.key?(:'calibration_factor')
        self.calibration_factor = attributes[:'calibration_factor']
      end

      if attributes.key?(:'min_fill_rate')
        self.min_fill_rate = attributes[:'min_fill_rate']
      end

      if attributes.key?(:'fill_timeout')
        self.fill_timeout = attributes[:'fill_timeout']
      end

      if attributes.key?(:'temperature_offset')
        self.temperature_offset = attributes[:'temperature_offset']
      end

      if attributes.key?(:'fill_presets')
        if (value = attributes[:'fill_presets']).is_a?(Array)
          self.fill_presets = value
        end
      end

      if attributes.key?(:'total_fill_count')
        self.total_fill_count = attributes[:'total_fill_count']
      end

      if attributes.key?(:'total_failed_count')
        self.total_failed_count = attributes[:'total_failed_count']
      end

      if attributes.key?(:'last_fill_session')
        self.last_fill_session = attributes[:'last_fill_session']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          empty_pressure == o.empty_pressure &&
          calibration_factor == o.calibration_factor &&
          min_fill_rate == o.min_fill_rate &&
          fill_timeout == o.fill_timeout &&
          temperature_offset == o.temperature_offset &&
          fill_presets == o.fill_presets &&
          total_fill_count == o.total_fill_count &&
          total_failed_count == o.total_failed_count &&
          last_fill_session == o.last_fill_session
    end
    ...
    def hash
      [id, deleted, created_on, created_by, modified_on, modified_by, name, serial_number, mac_address, device_type, active, disabled, username, connection_state, status, error, last_activity_time, rssi, firmware_version, is_latest_firmware, active_profile_id, active_profile_step_id, active_profile_session, sounds_enabled, empty_pressure, calibration_factor, min_fill_rate, fill_timeout, temperature_offset, fill_presets, total_fill_count, total_failed_count, last_fill_session].hash
    end
